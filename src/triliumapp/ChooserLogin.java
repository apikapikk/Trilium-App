 ...
 * @author USER
 */
public class ChooserLogin extends javax.swing.JFrame {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
       DashboardFormGuru dfg = new DashboardFormGuru();
       dfg.setVisible(true);
       dfg.revalidate();
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooserLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooserLogin().setVisible(true);
            }
        });
    }
